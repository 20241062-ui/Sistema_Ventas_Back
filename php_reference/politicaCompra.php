...
$sql = "SELECT vchtitulo,  vchcontenido FROM tblpoliticas ORDER BY intid ASC";
...
<head>
  ...
  <title>Políticas - FlashCode</title>
...
<main class="acerca-container">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) { ?>
            ...
            <h2><?php echo $row['vchtitulo']; ?></h2>
            <p><?php echo nl2br($row['vchcontenido']); ?></p>

    <?php 
        }
    } else {
        echo "<p>No hay políticas registradas en la base de datos.</p>";
    }
    ?>
</main>
